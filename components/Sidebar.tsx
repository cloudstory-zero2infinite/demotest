...
// Single source of truth for every valid Governance sub-tab value.
// Import this array anywhere you need to validate/enumerate sub-tabs
// (App.tsx routing, GovernanceTab.tsx) instead of redeclaring the list.
export const GOVERNANCE_SUB_TABS: GovernanceSubTab[] = [
    'assets',
    'policies',
    'vulnerability',
    'relationships',
...
interface SidebarProps {
    ...
    activeGovernanceSubTab?: GovernanceSubTab | null;
    isOpen: boolean;
    onToggle: () => void;
    onNavigate: (tab: MainTab | GovernanceSubTab, subTab?: OrgSubTab | GovernanceSubTab, itemId?: string) => void;
    isAdmin: boolean;
}
