            ...
            <div className="p-4">
                ...
                <div className="space-y-4">
                    <div className="w-full bg-gray-100 dark:bg-gray-700/50 rounded-full h-1.5 overflow-hidden">
                        <div 
                            className={`h-full transition-all duration-300 ease-out ${status === 'error' && completed === 0 ? 'bg-red-500' : 'bg-blue-600'}`} 
                            style={{ width: `${percent}%` }}
                        />
                    </div>
                    ...
                    <div className="flex justify-between text-xs items-center">
                        ...
                        <span className={`font-bold ${status === 'error' ? 'text-red-600 dark:text-red-400' : status === 'done' ? 'text-green-600 dark:text-green-400' : 'text-blue-600 dark:text-blue-400'}`}>
                            {percent}%
                        </span>
                    </div>
